...
def psnr(img1, img2, dynamic_range=1.0):
    # if flag_cut_bounds:
    #     img1 = img1[dim_cut - 1:-dim_cut, dim_cut - 1:-dim_cut,:]  #:
    #     img2 = img2[dim_cut - 1:-dim_cut, dim_cut - 1:-dim_cut,:]  #:
...
def _ssim(img1, img2, dynamic_range=1.0):
...
def ssim(img1, img2, dynamic_range=1.0):
